...
// TODO use Tabs from Aceternity UI instead of this file tab system
...
export const Skills = () => {
  ...
  return (
    <>
        ...
        <div id='skills'
        className=' w-full h-[90vh] min-h-[600px] overflow-hidden mt-1 py-8 rounded-lg my-12 '>
            <Tabs tabs={skillsList}
            containerClassName='flex justify-center'
            contentClassName='flex justify-center'
            tabClassName='bg-white mx-4 font-bold bg-slate-300'
            activeTabClassName='bg-[#00df9a]' />
        </div>
    </>
  )
}
